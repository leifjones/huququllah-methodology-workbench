...
- [ ] `docs/draft-explorer-architecture.md`
- [ ] `docs/deferred-private-ledger-concepts.md`
...
- [ ] Status, source/design boundary, first implementation seam, and staged fictional slices
- [ ] Minimal vocabulary, logical boundaries, and closed calculation behavior
- [ ] Explanation, privacy, testing, deferred decisions, and ready-to-code gate

### `docs/deferred-private-ledger-concepts.md`

- [ ] Status, purpose, and rationale for deferral
- [ ] Deferred concept clusters and re-entry gates
...
| 2026-07-24 | Landing page reframed around product direction | Codex (agent) | `README.md`; design-plan status, general-audience framing, and specification-readiness conclusion | Replaced the RFC/research-question landing page with the current public-explorer direction, removed gold-indexed design history from the landing page while retaining it in the canonical deeper documents, and removed the remaining RFC framing from the design plan. Reopened the design-plan whole-file, general-audience, and phase/readiness scopes; all revised README scopes remain unchecked. No human review is asserted. | Branch `agent/reframe-readme-around-explorer` |
| 2026-07-24 | Low-complexity entry posture added | Codex (agent) | README threshold explanation; design-plan below-threshold scenario and experience principles | Made no payment a complete outcome below the threshold, separated illustrative voluntary percentages from obligation, and guarded against treating an unassessed situation as below threshold. Reopened the design-plan whole-file and general-audience/experience scopes after the branch's intervening human review activity; preserved the checked phase/readiness scope because it was not changed again. No human reviewer, date, or outcome was inferred from the intervening commit. | [PR #14](https://github.com/leifjones/huququllah-methodology-workbench/pull/14) |
| 2026-08-22 | Explorer architecture reframed | Codex (agent) | `README.md` documentation map; design-plan phases and readiness criteria; new explorer-architecture and deferred-concepts documents | Replaced the conflicted PR #9 direction with a narrow explorer architecture and a clearly deferred private-ledger concept inventory. Split explorer-slice readiness from later private-ledger gates so future schemas do not block the public explorer. Added unchecked coverage for both documents and reopened the checked README and design-plan whole-file scopes plus their affected section scopes. No human review is asserted. | [PR #15](https://github.com/leifjones/huququllah-methodology-workbench/pull/15) |
