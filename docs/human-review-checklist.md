...
| 2026-07-20 | Focused invariant decision | LJ Jones (human) | Calculation invariant 20a — gold-price movement without economic augmentation | Confirmed promotion from candidate to derived design rule and requested an explicit rationale. Broader calculation-invariant review remains open. | User direction in project conversation |
