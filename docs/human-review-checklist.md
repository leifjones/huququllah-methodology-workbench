...
- [ ] `docs/draft-implementation-architecture.md`
- [ ] `docs/draft-domain-model.md`
...
- [ ] Status, products, documentation index, and research questions
...
- [ ] Status, architectural posture, product boundaries, and phase boundary
- [ ] Canonical assessment path, taxonomy, extension seams, interfaces, and adapters
- [ ] State lifecycles, syntactic builders, registration, and composition
- [ ] Explanation, diagnostics, multilingual readiness, versioning, and replay
- [ ] Persistence, privacy, rejected patterns, fitness tests, and open decisions

### `docs/draft-domain-model.md`

- [ ] Status, modeling posture, conceptual axes, value concepts, and domain vocabulary
- [ ] Scenarios, participants, ownership, financial history, holdings, and classification
- [ ] Assessments, obligations, remittances, intent, treatment, allocations, and lifecycle
- [ ] Currency, rate evidence, time, derived projections, and non-fields
- [ ] Phase boundary, privacy, deletion, language/text note, and open questions
...
| 2026-07-20 | Ledger coverage expanded | Codex (agent) | README documentation index; new draft implementation architecture and draft domain model documents | Added unchecked whole-file and section coverage for both pre-specification planning documents and clarified README documentation-index coverage. Existing README whole-file and affected section scope were already unchecked. No human review is asserted. | Branch `agent/draft-implementation-architecture` |
