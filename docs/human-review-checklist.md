...
| 2026-08-22 | Explorer architecture reframed | Codex (agent) | `README.md` documentation map; new explorer-architecture and deferred-concepts documents | Replaced the conflicted PR #9 direction with a narrow explorer architecture and a clearly deferred private-ledger concept inventory. Added unchecked coverage for both documents and reopened the checked README whole-file and documentation-map scope because the canonical map changed. No human review is asserted. | Branch `agent/narrow-explorer-architecture` |
