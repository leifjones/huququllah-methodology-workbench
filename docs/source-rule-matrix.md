...
| **Voluntary contribution below threshold** | [Application compilation, paragraph 63](https://www.bahai.org/library/authoritative-texts/compilations/huququllah-right-god/3) | A person who does not accumulate assessable property equal to 19 mithqáls has no obligation, but may contribute voluntarily. | Explicit guidance | Required amount below threshold is zero. Store any voluntary amount under a distinct category with explicit or unresolved future-credit treatment. | The interface must not imply that voluntary generosity changes the threshold rule. Whether and under what conditions such a contribution may be credited toward a later obligation requires focused review; an unset exclusion option does not establish eligibility. |
